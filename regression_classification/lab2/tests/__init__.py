...
def test_all():
    from lab2 import compute_cost
    test_compute_cost(compute_cost)

    from lab2 import compute_gradient
    test_compute_gradient(compute_gradient)

def test_compute_cost(target):
    ...
    print("\033[92mcompute_cost tests passed!")
...
def test_compute_gradient(target):
    ...
    print("\033[92mcompute_gradient tests passed!")
